...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/Highpower143/ExtraPlugin",
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Highpower143/NobitaBro",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/NandYadu1c"
)  # Example:- https://t.me/CreativeYdv
SUPPORT_GROUP = getenv(
    "BOYS_STATUS_GROUP", "https://t.me/NYCreation_Chatzone"
)  # Example:- https://t.me/NYCreation_Chatzone
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://envs.sh/rGQ.jpg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "https://envs.sh/rGQ.jpg":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "https://envs.sh/rGQ.jpg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://envs.sh/rGQ.jpg":
...
if TELEGRAM_AUDIO_URL:
    if TELEGRAM_AUDIO_URL != "https://envs.sh/rGQ.jpg":
...
if STREAM_IMG_URL:
    if STREAM_IMG_URL != "https://envs.sh/rGQ.jpg":
...
if SOUNCLOUD_IMG_URL:
    if SOUNCLOUD_IMG_URL != "https://envs.sh/rGQ.jpg":
...
if YOUTUBE_IMG_URL:
    if YOUTUBE_IMG_URL != "https://envs.sh/rGQ.jpg":
...
if TELEGRAM_VIDEO_URL:
    if TELEGRAM_VIDEO_URL != "https://envs.sh/rGQ.jpg":
